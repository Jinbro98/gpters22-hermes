...
> - **HERMES.md** 📋 — 에이전트가 **이 프로젝트에서 어떻게 일할지** 정해요. 작업 규칙, 지켜야 할 컨벤션 같은 거예요. `CLAUDE.md`랑 비슷해요.
>
...
**주의:** 사용자가 말하지 않은 항목은 절대 건드리지 마세요. 항목 삭제 전 한 번 더 확인. SOUL.md를 고치는데 프로젝트 얘기가 나오거나 HERMES.md를 고치는데 말투 얘기가 나오면 "그건 {다른 파일}에 더 맞아요"라고 안내.
...
9. **프리셋을 그대로 저장하고 끝냄** — 최소한 이름(SOUL)/프로젝트(HERMES)는 확인하고 바꿀 곳을 물어보세요.
